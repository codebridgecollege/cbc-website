...
Static website built with Next.js (static export), Tailwind CSS, shadcn/ui, and next-intl. Content is file-based so site owners can update the site by editing files in GitHub; pushing to `main` triggers a rebuild and redeploy.

## Web owners

If you are a non-coder, here's how you can edit the content of your website:
...
1. Create or open a codespace with "Code > Codespaces > Create codespace on main"
   ...
   ![Create codespace on main](./docs/github-codespace-create.png)
...
2. Tell the Copilot what changes you need to make. It will find and edit the relevant code
   ...
   ![Using Copilot assistant](./docs/github-codespace-using-agent.png)

3. After the LLM is done, you should have a list of changed files:

   ![Copilot assistant finished](./docs/github-codespace-assistant-done.png)
...
1. Click "+" button in the "SOURCE CONTROL" right-hand panel to select files to be saved
   ...
   ![Select files to be saved](./docs/github-codespace-git-add.png)

2. Write a short message describing the changes and click "Commit"

   ![Commit file changes](./docs/github-codespace-git-commit.png)
...
If you are a web developer, see details in [Development](./docs/development.md).
